...
def test_set_namespace_same_id_issues_no_sql(apply_migrations, db_url):
...
def test_set_namespace_different_id_still_queries(apply_migrations, db_url):
...
def test_set_namespace_context_is_exposed(apply_migrations, db_url):
...
def test_set_namespace_force_reloads_issues_sql(apply_migrations, db_url):
